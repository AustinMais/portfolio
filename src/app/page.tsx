...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 leading-relaxed text-slate-400 antialiased selection:bg-emerald-400/30 selection:text-emerald-100 lg:flex lg:justify-between lg:gap-4">
      <Header />
      <main
        id="content"
